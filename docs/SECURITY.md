...
*Authoritative Source: [`src/inference/prompt_safety.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/inference/prompt_safety.py), [`src/serving/rate_limit.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/serving/rate_limit.py), [`src/inference/local_tools.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/inference/local_tools.py)*

---

## 1. Prompt Injection Defenses & Input Sanitization

[`src/inference/prompt_safety.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/inference/prompt_safety.py) provides heuristic and pattern-based protection against jailbreak and prompt-injection attacks:
...
Local tools in [`src/inference/local_tools.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/inference/local_tools.py) enforce strict security boundaries:
...
- **Token Bucket Rate Limiting**: Implemented in [`src/serving/rate_limit.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/serving/rate_limit.py) with SQLite backing (`data/cache/rate-limits.sqlite`). Restricts burst and sustained request rates per IP or client token.
