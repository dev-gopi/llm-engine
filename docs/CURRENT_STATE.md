...
| **Tool Execution** | Local/MCP tools with strict JSON-envelope/schema validation and a bounded sequential orchestration loop; autonomous planning/reflection and parallel execution remain future work | [`src/inference/local_tools.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/inference/local_tools.py)<br>[`src/serving/backend.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/src/serving/backend.py)<br>[`tests/test_mcp_client.py`](file:///home/user/Downloads/llm-engine-boilerplate/llm-engine/tests/test_mcp_client.py) |
